...
module.exports = class PortalTemplate extends require('../../plugin') {
  ...
  async combine() {
    const project = readProject()
    const { isJava, hasMta, srvPath, hasHtml5Repo, hasXsuaa, hasApprouter, hasMultitenancy, hasHelm, hasHelmUnifiedRuntime } = project
    ...
    if (hasMta) {
      ...
      const additions = [srv, portal, portalDeployer]
      const relationships = [{
        insert: [portal, 'name'],
